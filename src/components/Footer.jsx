      ...
      <footer className="footer footer-center p-10 text-base-content rounded dark:bg-slate-900 dark:text-white">
        ...
        <nav>
          <div className="grid grid-flow-col gap-6">
            ...
            <a
              href="#"
              className="transition-colors duration-300 hover:text-sky-400 cursor-pointer"
            >
              <svg
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/sudin.subedi.73" target="_blank"
              className="transition-colors duration-300 hover:text-blue-600 cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
        ...
        <aside>
          <p>Copyright © 2025 - All right reserved by Mindriser Industries Ltd</p>
        </aside>
      </footer>
    </div>
  );
